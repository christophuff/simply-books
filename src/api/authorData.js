...
const toggleFavorite = (firebaseKey, currentValue) =>
  new Promise((resolve, reject) => {
    fetch(`${endpoint}/authors/${firebaseKey}.json`, {
      method: 'PATCH',
      headers: {
...
export { getAuthors, createAuthor, getSingleAuthor, deleteSingleAuthor, updateAuthor, getFavoriteAuthors, getAuthorBooks, toggleFavorite };
